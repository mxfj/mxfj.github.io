...
root@Python:/opt/git/mxfj.github.io# git push
...
Username for 'https://github.com': mxfj
Password for 'https://mxfj@github.com': 
To https://github.com/mxfj/mxfj.github.io
 ! [rejected]        master -> master (non-fast-forward)
error: failed to push some refs to 'https://github.com/mxfj/mxfj.github.io'
hint: Updates were rejected because the tip of your current branch is behind
hint: its remote counterpart. Integrate the remote changes (e.g.
hint: 'git pull ...') before pushing again.
hint: See the 'Note about fast-forwards' in 'git push --help' for details.
root@Python:/opt/git/mxfj.github.io# git push origin master
Username for 'https://github.com': mxfj
Password for 'https://mxfj@github.com': 
To https://github.com/mxfj/mxfj.github.io
 ! [rejected]        master -> master (non-fast-forward)
...
hint: 'git pull ...') before pushing again.
hint: See the 'Note about fast-forwards' in 'git push --help' for details.
root@Python:/opt/git/mxfj.github.io# cat README.md 
hexo-theme-yilia
================
